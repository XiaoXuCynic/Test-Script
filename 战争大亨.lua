...
WindUI:Popup({
    Title = '<font color="' .. gradientColors[1] .. '">Emotion</font><font color="' .. gradientColors[5] .. '">Hub</font>',
    IconThemed = true,
    Content = "尊敬的用户 " .. coloredUsername .. " \n您使用的 <font color='" .. gradientColors[1] .. "'>战争大亨</font><font color='" .. gradientColors[5] .. "'></font> 当前版本型号是: " .. coloredVersion .. "\n感谢你的大力支持Break在这里祝你们新年快乐！",
    Buttons = {
        {
            Title = "取消",
...
function createUI()
    local Window = WindUI:CreateWindow({
        ...
        Resizable = true,
        Background = "https://raw.githubusercontent.com/XiaoXuCynic/UI-Picture/refs/heads/main/Image_1770861548841_155.jpg",
